...
class DebugInfo(BaseModel):
    ...
    provider_addresses: List[StrictStr] = Field(alias="providerAddresses")
    discovery_addresses: List[StrictStr] = Field(alias="discoveryAddresses")
    ...
    __properties: ClassVar[List[str]] = ["id", "addrs", "spr", "providerRecord", "providerAddresses", "discoveryAddresses", "libp2pPubKey", "mixPubKey", "table", "storage", "nat", "connections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "providerAddresses": obj.get("providerAddresses"),
            "discoveryAddresses": obj.get("discoveryAddresses"),
